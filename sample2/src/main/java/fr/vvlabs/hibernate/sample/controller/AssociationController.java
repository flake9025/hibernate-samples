...
public class AssociationController {
  ...
  @Operation(summary = "Find", description = "Find a association")
  @GetMapping(value = "/{id}")
  ...
  @Operation(summary = "Create", description = "Create a association")
  @PostMapping
  ...
  @Operation(summary = "Update", description = "Update a association")
  @PutMapping(value = "/{id}")
  ...
  @Operation(summary = "Delete", description = "Delete a association")
